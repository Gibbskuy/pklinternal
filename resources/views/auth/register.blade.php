                ...
                <div class="col-12 col-xl-5 col-xxl-4 auth-cover-right align-items-center justify-content-center">
                    <div class="card rounded-0 m-3 border-0 shadow-none bg-none">
                        <div class="card-body p-sm-5">
                            ...
                            <h4 class="fw-bold">Bikin lah Akun Anda</h4>
                            <p class="mb-0">
                                Masukkan kredensial Anda untuk masuk ke akun Anda</p>
                                ...
                                <form class="row g-3" method="post" action="{{ route('register') }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="email" name="email"
                                            ...
                                            id="inputEmailAddress" placeholder="email@example.com">
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }} </strong>
                                            @enderror
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button type="submit" class="btn btn-grd-danger text-white">Register</button>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="text-start">
                                            <p class="mb-0">Sudah Punya Akun? <a
                                                    href="{{ url('login') }}">Segera Login</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
