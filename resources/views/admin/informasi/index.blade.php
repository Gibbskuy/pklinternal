            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-header"><b>Data Informasi</b>
                        <a href="{{ route('informasi.create') }}" class="btn btn-sm btn-primary" style="float: right">Tambah</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($informasi as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <center><img src="{{ asset('images/informasi/' . $item->foto) }}" width="150"
                                                        height="100"></center>
                                            </td>
                                            <td>
                                                <form action="{{ route('informasi.destroy', $item->id) }}" method="post">
                                                    ...
                                                    <center>
                                                        ...
                                                        <a href="{{ route('informasi.destroy', $item->id) }}" class="btn btn-outline-danger"
