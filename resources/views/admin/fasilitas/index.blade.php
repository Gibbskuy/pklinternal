                            ...
                            <table class="table table-bordered" id="datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <center>Nama Fasilitas</center>
                                        </th>
                                        <th>
                                            <center>Deskripsi</center>
                                        </th>
                                        <th>
                                            <center>Foto Fasilitas</center>
                                        </th>
                                    </tr>
                                </thead>
                                @php $no = 1; @endphp
                                <tbody>
                                    @foreach ($fasilitas as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <center>{{ $item->fasilitas }}</center>
                                            </td>
                                            <td>
                                                <center>{{ $item->deskripsi }}</center>
                                            </td>
                                            <td>
                                                <center><img src="{{ asset('images/fasilitas/' . $item->foto) }}" width="150"
                                                        height="100"></center>
                                            </td>
                                            <td>
                                                <form action="{{ route('fasilitas.destroy', $item->id) }}" method="post">
                                                    ...
                                                    <center>
                                                        ...
                                                        <a href="{{ route('fasilitas.destroy', $item->id) }}" class="btn btn-outline-danger"
