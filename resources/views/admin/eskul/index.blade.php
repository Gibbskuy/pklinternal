                                ...
                                <tbody>
                                    @foreach ($eskul as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <center>{{ $item->eskul }}</center>
                                            </td>
                                            <td>
                                                <center>{{ $item->deskripsi }}</center>
                                            </td>
                                            <td>
                                                <center><img src="{{ asset('images/eskul/' . $item->foto) }}" width="150"
                                                        height="100"></center>
                                            </td>
                                            <td>
                                                <form action="{{ route('eskul.destroy', $item->id) }}" method="post">
                                                    ...
                                                    <center>
                                                        ...
                                                        <a href="{{ route('eskul.destroy', $item->id) }}" class="btn btn-outline-danger"
